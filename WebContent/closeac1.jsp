...
<div  style="background-image: url('http://vita.vision.org.in/wp-content/uploads/2020/04/Capture1.png');" id="header">
...
<tr >
    ...
    <td width="1200" valign="top">
    	<div id="welcome" style="border-right:#666666  ;"><h1>CLOSE ACCOUNT FORM</h1><br>
		...
		<tr>
			...
			out.print(request.getAttribute("balance"));
			 ...
			 %></div>
				<form name=F1 onSubmit="return validate()" action="closeac.jsp" >
					...
					<tr><td>PASSWORD:</td><td> <input type="password" id="" name="password"/></td></tr>
     ...
     <td width="299" valign="top">
    	<div id="welcome" style="border-right:#666666 ;"><h1>Welcome</h1><br>
    	    <center><img src=" https://thumbs.gfycat.com/PlushFinishedBantamrooster-size_restricted.gif" alt="business" width="196" height="106"></center><br>
...
<div id="footer_top">
  ...
  <div id="footer_copyright" >
    	    ...
    	    <center><img  src="https://cdn.pixabay.com/photo/2020/07/08/04/12/work-5382501__340.jpg" alt="business"  width="196" height="106"></center><br>
		    <p>Each people plan their site layouts depending upon their business type. Here comes a free designer template which provides you with a selection of different kinds of webdesign   starting from business template, fashion template, media template, Science template, Arts template and much more.</p>
